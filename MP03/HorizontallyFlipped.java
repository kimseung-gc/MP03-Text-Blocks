...
/**
 * Horizontally flipped class for Textblocks
 * 
...
public class HorizontallyFlipped implements TextBlock {
  ...
  public HorizontallyFlipped(TextBlock _inp){
    this.inp = (_inp == null) ? new TextLine(null): _inp;
  } // HorizontallyFlipped(TextBlock)

  /**
   * Build a new TextBlock horizontally flipped
   * 
  ...
  public String row(int i) throws Exception{
    ...
    if(i >= this.inp.height() || i < 0){
      ...
      for(int j = 0; j < this.inp.width(); j++){
        ...
        ret = this.inp.row(i).charAt(j) + ret;
      }
      /* return the result */
      return ret;
    } // if/else
